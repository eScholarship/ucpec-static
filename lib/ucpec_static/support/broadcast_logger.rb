...
module UCPECStatic
  module Support
    # A port of a fixed, taggable broadcast logger from future version of Rails
    #
    # @see https://github.com/rails/rails/pull/53093
